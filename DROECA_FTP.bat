...
"C:\Program Files (x86)\WinSCP\WinSCP.exe" ^
  /log="%1\FTP_DROECA_%anio%%mes%%dia%_%hora%%minuto%.log" /ini=nul ^
  /command ^
    "open ftp://droeca%%40dev.purofarma.com:0kL93qU3Awnm@192.145.237.165/ -rawsettings ProxyPort=0" ^
	"lcd \\10.1.240.16\Compartidos\Mercadeo\Droeca " ^
	"synchronize  remote " ^
    "exit"
